...
awk '{print}' "$MODPATH/common/fscc_banner"
ui_print "Version: $(grep_prop version "$MODPATH/module.prop")"
ui_print ""
ui_print "FSCC is a userspace-like pinner"
ui_print ""
...
wget -O "$MODPATH/system/bin/fscc" "https://raw.githubusercontent.com/pedrozzz0/fscc/master/fscc"
...
ui_print ""
ui_print "[*] FSCC log(s) are stored in internal storage/ktsr"
ui_print ""
